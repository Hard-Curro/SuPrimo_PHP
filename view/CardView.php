...
var_dump(unserialize(base64_decode($_COOKIE['cookieGod'])));
                ...
                <?php foreach ($items as $item): ?>
                        ...
                        <div id="caja-card">
                            <div class="card h-100" style="width: 18rem;">
                                <div class="img-div"><img src="data:image/jpeg;base64,<?= $pro->imagen?>" class="card-img-top" alt="image"></div>
                                <?= $pro -> imagen ?>
                                <div class="card-body">
                                    <h5 class="card-title"><?= $pro->nombre; ?></h5>
                                    <p class="card-text"><?= $pro->descripcion; ?></p>
                                    <p class="card-text fw-bold"><?= $pro->precio*$item["quantity"]."€" ?></p>
                                    <p class="card-text fw-bold"><?= "Quantity: ".$item["quantity"] ?></p>
                                </div>
                            
                     
                        
                        <a href="../controller/CartController.php?id=<?= $pro->id?>&type=<?= $pro->type?>">Delete product</a>
                        </div>
                        </div>
                    <?php endforeach; ?>
                    </div>
